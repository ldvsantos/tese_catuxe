...
- Dossiês de salvaguarda exigem conformidade com múltiplas instâncias (IPHAN, INPI, CGen, FAO)
- Verificação manual: lenta, subjetiva, não rastreável
- Necessidade de auditoria automatizada e criptograficamente ancorada
:::
...
- Sistema ISB precisa de validação territorial com as comunidades
- Usabilidade e adoção são críticas para sustentabilidade
...
## Cap. 1 – Resultados Parciais {.smaller-text}
...
| Indicador | Valor |
|-----------|-------|
| Acurácia combinada | **90,7%** (IC 95%: 89,8–91,5%) |
| Heterogeneidade I² | 58% |
| Conformidade FAIR | **18,7/100** |
| Compartilhamento dados | 1,1% |
| Viés (Egger) | p = 0,009 |
:::
...
1. Validação espacial insuficiente
2. Explicabilidade (XAI) ausente
3. Governança de dados precária
4. FAIR criticamente baixo
:::

**→ Prontidão insuficiente para uso regulatório**
...
## Cap. 2 – Resultados Parciais {.smaller-text}
...
- Am. do Sul: fragilidade jurídica **37,1%**
- Bosques sagrados: proteção máxima (β = +1,5)

::: {.highlight-box}
**Tríade de ação**

1. Reforço jurídico-fundiário
2. Governança comunitária
...
- Protocolo Beaton (6 etapas) + mestres quilombolas
- **IVC global ≥ 0,90** · Kappa ≥ 0,75
- Pré-teste: 10–15 agricultores (Jeremoabo, BA)
- Versão final: **WOCAT-SLM-QBR**
:::
...
::: {.highlight-box}
**Resultado:** variáveis linguísticas com dupla legitimidade (técnica + cultural)
...
::: {.columns}
::: {.column width="50%"}
### Calibração TRI + Fuzzy

- TRI: limiares δᵢₖ → escores latentes θₙ
...
Aderência ISB vs. percepção comunitária (RMSE)

Maior concordância que classificações lineares
...
::: {.column width="50%"}
::: {.highlight-box}
Padronização e rastreabilidade superiores à verificação manual
...
## Arquitetura Integrada do Modelo {.smaller-text}

::: {.columns}
::: {.column width="50%"}
### Fluxo Sequencial

**Cap. 1** – PRISMA-ScR → Diagnóstico ML

⬇️

**Cap. 2** – Meta-análise → Magnitudes V₁–V₈

⬇️

**Cap. 3** – WOCAT-QBR + Delphi → Variáveis linguísticas

⬇️

**Cap. 4** – TRI + Fuzzy → ISB (0–100)

⬇️

**Cap. 5** – BN + NLP + DLT → Dossiê auditável
:::
...
- Articulação RBV + salvaguarda biocultural
- 8 dimensões com magnitudes empíricas
:::

::: {.info-box}
**Metodológica**

- Integração TRI + Fuzzy → ISB
- Auditoria normativa automatizada
- Adaptação WOCAT-SLM para quilombolas
:::

::: {.highlight-box}
**Prática**

- ISB como instrumento de gestão pública
- Dossiês conformes (IPHAN, INPI, CGen, FAO)
- Rastreabilidade criptográfica via DLT
:::
:::
:::
...
## Resultados Consolidados {.smaller-text}
...
| H | Status |
|---|--------|
| **H1** – ML insuficiente | ✅ FAIR: 18,7/100 |
| **H2** – Dimensões diferem | ✅ V₄: −24,3%; V₈: +32,3% |
| **H3** – Consenso superior | ✅ IVC ≥ 0,90; W ≥ 0,70 |
| **H4** – Concordância ISB | ✅ RMSE |
| **H5** – Padronização | ✅ P(Cᵢ│e) ≥ 0,85 |
| **H6** – Adoção | *(Em validação)* |
:::
...
1. Reforço jurídico-fundiário (V₄)
2. Governança comunitária (V₅)
3. Adaptação climática (V₈)
:::

::: {.info-box}
**Propriedade Intelectual**

- Proteção *sui generis* de CT
- Dossiês automatizados reduzem custos de *compliance*
- Integração com INPI, CGen, IPHAN, FAO
:::
:::
:::
