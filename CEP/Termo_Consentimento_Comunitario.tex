...
Aos \rule{2cm}{0.4pt} dias do mês de \rule{3cm}{0.4pt} de \rule{3cm}{0.4pt}, na sede da \rule{6cm}{0.4pt} (associação/espaço comunitário), reuniram-se membros da comunidade quilombola \rule{6cm}{0.4pt}, certificada pela Fundação Cultural Palmares, juntamente com o pesquisador responsável Prof. Dr. Luiz Diego Vidal Santos e a doutoranda Catuxe Varjão de Santana Oliveira, para apresentação e deliberação sobre a realização da pesquisa acima identificada no território da comunidade.

\section*{Apresentação da Pesquisa}

A equipe de pesquisa apresentou de forma clara e em linguagem acessível os seguintes aspectos da pesquisa.
...
\paragraph{Atividades previstas na comunidade.} As atividades incluem a aplicação de questionários sobre práticas agrícolas tradicionais (em formato de entrevista assistida), entrevistas individuais gravadas em áudio, registro fotográfico de práticas agrícolas, sistemas de cultivo e paisagens para documentação científica, e oficinas devolutivas para apresentação e validação dos resultados pela comunidade. Nenhuma fotografia que permita a identificação individual de participantes será publicada sem autorização expressa do(a) retratado(a).
...
Após a apresentação, foi aberto espaço para perguntas e esclarecimentos dos membros da comunidade. Todas as dúvidas foram respondidas pela equipe de pesquisa.
...
\noindent Nada mais havendo a tratar, foi encerrada a reunião, da qual se lavrou a presente ata, que vai assinada pelo pesquisador responsável, pela doutoranda e pelas lideranças comunitárias presentes.
...
Pesquisador Responsável --- UEFS / PPGPI-UFS
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\textwidth}
\centering
