...
\chapter{CAPÍTULO 2: Adaptação Transcultural do Questionário WOCAT-SLM e Elicitação Estruturada de Saberes Agroecológicos Tradicionais via Delphi em Comunidades Quilombolas do Semiárido Nordeste II}
...
O estudo insere-se no Objetivo Específico 2 (OE2) de um programa de pesquisa dedicado ao desenvolvimento de sistema integrado de governança bioeconômica para o Território de Identidade Semiárido Nordeste II (Bahia), articulando revisão de escopo (OE1, Capítulo~1), adaptação transcultural e elicitação estruturada (OE2, este Capítulo), modelagem psicométrica e fuzzy (OE3, Capítulo~3), validação de mercado (OE4) e design participativo (OE5). Nessa arquitetura, o presente capítulo opera como ponte metodológica entre o diagnóstico tecnológico do Capítulo~1 e a construção do motor de inferência fuzzy, fornecendo simultaneamente instrumento culturalmente calibrado e variáveis de entrada validadas.
...
\item \textbf{Insumo direto para o OE3} (Capítulo~3): as variáveis validadas constituirão os antecedentes do motor de inferência fuzzy do Índice de Valoração Bioeconômica (IVB).
\end{enumerate}
...
Na arquitetura mais ampla desta tese, o presente capítulo opera como fundação metodológica: o instrumento culturalmente calibrado e as variáveis consensuadas alimentarão diretamente as funções de pertinência e regras SE-ENTÃO do sistema fuzzy Mamdani (OE3/Capítulo~3). Cada variável do IVB terá origem documentada em adaptação transcultural e consenso especializado, conferindo rastreabilidade ao modelo \cite{Costanza1997} e atendendo à cadeia de evidências: WOCAT original $\rightarrow$ WOCAT-SLM-QBR $\rightarrow$ consenso Delphi $\rightarrow$ modelo fuzzy.
