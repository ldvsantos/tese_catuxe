...
A vulnerabilidade biocultural é modelada como construto latente hexadimensional, derivado da convergência entre taxonomias de erosão de conhecimento tradicional \cite{Agrawal2002} e indicadores de resiliência socioecológica \cite{Folke2016}. As seis dimensões funcionais compreendem a Erosão Intergeracional ($V_1$), relativa à descontinuidade na transmissão vertical do conhecimento; a Complexidade Biocultural ($V_2$), que mensura a riqueza de interações ecológicas codificadas nos sistemas tradicionais; a Singularidade Territorial ($V_3$), referente à exclusividade geográfica das práticas; o Status de Documentação ($V_4$), que avalia o grau de registro formal preexistente; a Vulnerabilidade Jurídica ($V_5$), correspondente à exposição a apropriação indevida; e a Organização Social ($V_6$), que expressa a vitalidade das estruturas comunitárias de governança do conhecimento.
