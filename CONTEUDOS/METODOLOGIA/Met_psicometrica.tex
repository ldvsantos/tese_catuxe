...
A aplicação de métodos psicométricos nesta pesquisa configura-se como instrumento fundamental para a \textbf{mensuração estruturada de dimensões de conhecimento tradicional que alimentam o sistema computacional de salvaguarda}. A documentação rigorosa de saberes coletivos enfrenta desafio crítico, a saber, a ausência de métricas quantitativas objetivas que permitam comparação, priorização e rastreabilidade dos ativos intangíveis em processos de proteção junto a instâncias regulatórias.

Os instrumentos psicométricos desenvolvidos nesta pesquisa, baseados na Teoria de Resposta ao Item (TRI) e Análise Fatorial Confirmatória (AFC), operacionalizam a conversão de atributos qualitativos dos conhecimentos tradicionais em \textbf{perfis quantitativos de complexidade, vulnerabilidade e singularidade}, viabilizando sua integração como variáveis de entrada no sistema fuzzy (ISB) e como evidência documental em dossiês de salvaguarda \cite{SmithParr2000,ZhouWang2022}.

A metodologia psicométrica proposta contribui para a salvaguarda de ativos intangíveis em duas frentes complementares. Na primeira, construtos psicométricos validados (conhecimentos etnoclimatológicos, etnopedológicos, etnoecológicos, percepção de urgência de salvaguarda, adaptabilidade, originalidade e práticas comunitárias) constituem \textbf{proxies mensuráveis} para dimensões de vulnerabilidade e complexidade dos saberes tradicionais, permitindo comparação sistemática e identificação daqueles com maior risco de erosão intergeracional ou maior singularidade territorial, subsidiando decisões de priorização de salvaguarda. Na segunda, os escores TRI produzem perfis individuais e comunitários de profundidade de conhecimento, que alimentam diretamente o sistema fuzzy (ISB) como variáveis de entrada e compõem a seção de evidência psicométrica dos dossiês submetidos a instâncias regulatórias, conferindo rastreabilidade e robustez probatória à documentação.

A validação psicométrica rigorosa proposta nesta pesquisa, incluindo validade de conteúdo (CVC), validade de construto (AFC com CFI $\geq$ 0,95, RMSEA $\leq$ 0,06), confiabilidade ($\alpha$ de Cronbach $\geq$ 0,80) e validade baseada em TRI, garante que os instrumentos atendam aos \textbf{Standards for Educational and Psychological Testing} \cite{Association2018}, conferindo robustez técnica aos perfis de salvaguarda derivados.

Esta abordagem preenche lacuna identificada na literatura de documentação de patrimônio imaterial \cite{Lev2001,WuLi2022}, notadamente a ausência de metodologias estruturadas para mensuração de dimensões de saberes coletivos de natureza tradicional. A psicometria, tradicionalmente aplicada a medidas educacionais e psicológicas, é aqui reinterpretada como \textbf{tecnologia de documentação e diagnóstico para salvaguarda}, ampliando o escopo de ferramentas disponíveis para instâncias regulatórias e gestores de patrimônio imaterial.
...
O segundo construto será avaliado a partir da percepção de urgência de salvaguarda do conhecimento tradicional. Esta dimensão será composta por questões que buscam compreender a percepção dos povos e comunidades tradicionais quanto à vulnerabilidade e necessidade de proteção de suas práticas e saberes agrícolas acumulados ao longo de gerações \cite{Cordero2018}. Esses conhecimentos, muitas vezes transmitidos oralmente entre gerações, representam fonte singular de informações sobre o meio ambiente e estratégias de manejo, cuja documentação e proteção formal permanecem incipientes.
