...
\item \textbf{Q1 – Fricção Institucional e Custos de Transação:}
Em que medida a sistematização de requisitos legais e procedimentais em um protocolo de governança reduz custos de transação para o registro e a proteção de ativos tradicionais?

\item \textbf{Q2 – Estruturação de Saberes Tácitos:}
Como métodos estruturados de elicitação (ex.: Delphi) contribuem para converter saberes tácitos em variáveis mensuráveis, aumentando consenso e comparabilidade entre avaliadores?
...
\item \textbf{H1 – Fricção Institucional e Custos de Transação:}
A sistematização dos requisitos de conformidade legal em um protocolo de governança reduz os custos de transação para registro e proteção de ativos tradicionais.
...
\item Diagnosticar o ambiente institucional e regulatório de proteção aos conhecimentos tradicionais, mapeando gargalos de governança e custos de transação que impedem o acesso efetivo das comunidades aos marcos legais vigentes.
...
\begin{enumerate}[label=\bfseries(\Roman*)]
  \item \textbf{Diagnóstico institucional e regulatório:} análise documental e mapeamento de processos para identificar fricções de governança e custos de transação associados à proteção e registro de ativos tradicionais;
