...
extrair_dados_modelagem <- function(caminho_bib) {
  ...
  dados <- data.frame(
    ...
    Interview = as.integer(grepl("interview|semi-structured", texto_completo)),
    Participatory = as.integer(grepl("participatory|community-based", texto_completo)),
    Observation = as.integer(grepl("participant observation|field work", texto_completo)),
    ...
    LocalKnowledge = as.integer(grepl("local knowledge|community knowledge", texto_completo)),
    ...
    OrganicFarming = as.integer(grepl("organic farming|ecological", texto_completo)),
    
    # Aplicações
    KnowledgeMapping = as.integer(grepl("knowledge mapping|documentation", texto_completo)),
    PatternRecognition = as.integer(grepl("pattern recognition|data mining", texto_completo)),
    SpatialAnalysis = as.integer(grepl("spatial analysis|gis", texto_completo)),
    TextAnalysis = as.integer(grepl("text analysis|content analysis", texto_completo)),
