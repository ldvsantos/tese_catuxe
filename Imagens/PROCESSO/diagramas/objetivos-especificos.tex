...
\node[OEstyle, right=0.20cm of OE1] (OE2)
  {\textbf{OE\,2}\\[1pt]
  Sintetizar magnitudes de efeito das 6 dimens\~oes $V_1$--$V_6$ via meta-an\'alise PRISMA\,2020};
...
\node[Qstyle, below=0.55cm of OE2] (Q2)
  {\textbf{Q\,2}\\[1pt]
  Quais dimens\~oes $V_1$--$V_6$ exercem maior magnitude de efeito sobre resili\^encia?};
