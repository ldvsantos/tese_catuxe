...
\node[Qstyle, below=0.55cm of OE2] (Q2)
  {\textbf{Q\,2}\\[1pt]
  Como as dimens\~oes $V_1$--$V_8$ se associam \`a degrada\c{c}\~ao e quais fatores as modulam?};
...
\node[Hstyle, below=0.55cm of Q2] (H2)
  {\textbf{H\,2}\\[1pt]
  Ao menos uma dimens\~ao $V_1$--$V_8$ difere significativamente das demais em magnitude de efeito};
...
\node[CVstyle, below=0.9cm of C3.south east] (CV) {%
  ...
  dimens\~oes $V_1$--$V_8$\,(H2) $\rightarrow$
